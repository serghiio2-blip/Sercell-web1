...
const Contact: React.FC = () => {
  ...
  return (
    <section id="contacto" className="relative py-32 overflow-hidden">
      {/* Background Image Layer: Electronic Schematic */}
      ...
      <div className="container mx-auto px-6 relative z-10 text-white">
        <div className="grid lg:grid-cols-2 gap-20">
          <div>
            ...
            <div className="space-y-10">
              <motion.a 
                ...
                className="flex items-start gap-8 group cursor-pointer bg-white/5 backdrop-blur-md p-8 rounded-[3rem] border border-white/5 transition-all shadow-xl"
              >
              ...
              <motion.a 
                ...
                className="flex items-start gap-8 group cursor-pointer bg-emerald-500/5 backdrop-blur-md p-8 rounded-[3rem] border border-emerald-500/5 transition-all shadow-xl"
              >
          ...
          <motion.div 
            ...
            className="bg-black/60 backdrop-blur-2xl border-2 border-blue-500/20 p-14 rounded-[5rem] shadow-[0_0_100px_rgba(0,0,0,1)] relative overflow-hidden"
          >
