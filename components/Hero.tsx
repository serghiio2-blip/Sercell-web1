...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative h-screen w-full flex items-center justify-center overflow-hidden bg-black">
      {/* Background Ultra-Futurista: Micro-arquitectura con Neón */}
      <div className="absolute inset-0 z-0">
        ...
        <img 
          ...
          className="w-full h-full object-cover opacity-80 scale-105 animate-[pulse_8s_infinite_alternate]"
        />
        {/* Capa de neón pulsante extra */}
        <div className="absolute inset-0 opacity-30 bg-[radial-gradient(circle_at_center,_var(--tw-gradient-stops))] from-blue-500/20 via-transparent to-transparent animate-pulse" />
      </div>
      ...
      <div className="relative z-20 container mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="max-w-3xl mx-auto text-white text-xl md:text-3xl font-bold mb-14 leading-tight drop-shadow-[0_5px_15px_rgba(0,0,0,1)]">
            Especialistas en la micro-arquitectura de <br />
            <span className="text-blue-400 underline decoration-blue-500/50">Xiaomi 14 Ultra</span> & <span className="text-blue-400 underline decoration-blue-500/50">Motorola Edge 50</span>.
          </p>
        </motion.div>
      ...
      <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-3 opacity-40">
        ...
        <div className="w-[2px] h-16 bg-gradient-to-b from-blue-500 via-blue-500/20 to-transparent" />
      </div>
    </section>
  );
};
